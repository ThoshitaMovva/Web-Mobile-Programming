  ...
  getVenues() {
    ...
    if (this.recipeValue !== null) {
      ...
      subscribe(respReceipe => {
        ...
        // this.recipeList = this.receipe.hits[0].recipe;
        // if (this.receipe.hits.length === 0) {
        //   Swal.fire('Please enter a food item to search');
        // } else {
        //   for (let i = 0; i < this.receipe.hits.length; i++) {
        //     // this.recipeList(this.receipe.hits[i].recipe.url);
        //   }
        // }
      }, error => {});
