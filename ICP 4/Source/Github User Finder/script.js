...
// setting the html to elemnts in page using jQuery
    ...
    $(".information").html("<label><u><strong>User Information</strong></u></label>" +
        "<br/><br/><label style='color: #f0ad4e'>Login Name : </label>"+ user.name
        +"<br/><label style='color: #449d44'> Login ID : </label>"+ user.id
        +"<br/> <label style='color: #2e6da4'>GitHub URL : </label>"+link
        +"<br/> <label style='color: #b300b3'>GitHub Public Repos Of the User : </label>"+ user.public_repos);
    $("#profile").show();
